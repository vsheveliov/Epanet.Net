...
///<summary>Network 2D rendering class for the EpanetUI class.</summary>
public class NetworkImage {
    ...
    private const Color PIPES_FILL_COLOR = new Color(0x666666);

    private const Color NODE_STROKE_COLOR = new Color(0, 0, 0, .5f);
    private const Color NODE_FILL_COLOR = new Color(0xcc / 256f, 0xcc / 256f, 0xcc / 256f, .4f);
    private const int NODE_DIAM = 2;
