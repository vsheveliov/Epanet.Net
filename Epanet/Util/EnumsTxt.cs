...
namespace Epanet.Util {
    ...
    public static class EnumsTxt {
        ...
        public static string ParseStr(this PropertiesMap.StatFlag value) {
            switch (value) {
            case PropertiesMap.StatFlag.NO:      return Keywords.w_NO;
            case PropertiesMap.StatFlag.FULL:    return Keywords.w_FULL;
            case PropertiesMap.StatFlag.YES:     return Keywords.w_YES;
            default:                             return null;
            }
        }
        ...
        public static bool TryParse(string text, out PropertiesMap.PressUnitsType result) {
            if(text.Match(Keywords.w_PSI))         result = PropertiesMap.PressUnitsType.PSI;
            else if(text.Match(Keywords.w_KPA))    result = PropertiesMap.PressUnitsType.KPA;
            else if(text.Match(Keywords.w_METERS)) result = PropertiesMap.PressUnitsType.METERS;
            else {
                result = (PropertiesMap.PressUnitsType)(-1);
                return false;
            }
        ...
        public static bool TryParse(string text, out PropertiesMap.FormType result) {
            if(text.Match(Keywords.w_HW))       result = PropertiesMap.FormType.HW;
            else if(text.Match(Keywords.w_DW))  result = PropertiesMap.FormType.DW;
            else if(text.Match(Keywords.w_CM))  result = PropertiesMap.FormType.CM;
            else {
                result = (PropertiesMap.FormType)(-1);
                return false;
            }
        ...
        public static bool TryParse(string text, out PropertiesMap.HydType result) {
            if(text.Match(Keywords.w_USE))       result = PropertiesMap.HydType.USE;
            else if(text.Match(Keywords.w_SAVE)) result = PropertiesMap.HydType.SAVE;
            else {
                result = (PropertiesMap.HydType)(-1);
                return false;
            }
